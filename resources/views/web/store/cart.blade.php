        ...
        @else
            <div class="grid gap-10 lg:grid-cols-[1.4fr,0.8fr]">
                ...
                <aside class="border border-[var(--color-border)] bg-white p-6 h-fit lg:sticky lg:top-6">
                    ...
                    @else
                        <a href="{{ route('web.checkout.show') }}" class="btn btn-primary w-full mb-3">Proceed to checkout</a>
                        <p class="mb-4 text-xs text-center text-[var(--color-soft-grey)]">Choose delivery or clinic pickup at checkout. Any delivery fee and tax will be shown before payment.</p>
                    @endif
