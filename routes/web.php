...
Route::get('/checkout/status/{number}', [CheckoutController::class, 'status'])->middleware('throttle:30,1')->name('web.checkout.status');
Route::get('/checkout/callback', [CheckoutController::class, 'callback'])->middleware('throttle:60,1')->name('web.checkout.callback');
